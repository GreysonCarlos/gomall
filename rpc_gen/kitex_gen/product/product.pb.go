...
type ListProductReq struct {
	...
	CatagoryName string `protobuf:"bytes,3,opt,name=catagory_name,json=catagoryName,proto3" json:"catagory_name,omitempty"` // 根据分类名称获取商品列表
}
...
func (x *ListProductReq) GetCatagoryName() string {
	if x != nil {
...
type Product struct {
	...
	Catagories  []string `protobuf:"bytes,6,rep,name=catagories,proto3" json:"catagories,omitempty"`
}
...
func (x *Product) GetCatagories() []string {
	if x != nil {
		return x.Catagories
	}
	return nil
...
var file_product_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x61, 0x67, 0x6f, 0x72, 0x79, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x0c, 0x63, 0x61, 0x74, 0x61, 0x67, 0x6f, 0x72, 0x79, 0x4e, 0x61, 0x6d, 0x65,
	...
	0x63, 0x65, 0x12, 0x1e, 0x0a, 0x0a, 0x63, 0x61, 0x74, 0x61, 0x67, 0x6f, 0x72, 0x69, 0x65, 0x73,
	0x18, 0x06, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0a, 0x63, 0x61, 0x74, 0x61, 0x67, 0x6f, 0x72, 0x69,
	0x65, 0x73, 0x22, 0x40, 0x0a, 0x10, 0x4c, 0x69, 0x73, 0x74, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63,
	...
	0x32, 0xea, 0x01, 0x0a, 0x14, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x43, 0x61, 0x74, 0x61,
	0x6c, 0x6f, 0x67, 0x53, 0x65, 0x72, 0x76, 0x69, 0x65, 0x12, 0x44, 0x0a, 0x0c, 0x4c, 0x69, 0x73,
	...
	0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x73, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x42, 0x3b, 0x5a,
	0x39, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x47, 0x72, 0x65, 0x79,
	0x73, 0x6f, 0x6e, 0x43, 0x61, 0x72, 0x6c, 0x6f, 0x73, 0x2f, 0x67, 0x6f, 0x6d, 0x61, 0x6c, 0x6c,
...
var file_product_proto_depIdxs = []int32{
	...
	0, // 3: product.ProductCatalogServie.ListProducts:input_type -> product.ListProductReq
	3, // 4: product.ProductCatalogServie.GetProduct:input_type -> product.GetProductReq
	5, // 5: product.ProductCatalogServie.SearchProducts:input_type -> product.SearchProductsReq
	2, // 6: product.ProductCatalogServie.ListProducts:output_type -> product.ListProductsResp
	4, // 7: product.ProductCatalogServie.GetProduct:output_type -> product.GetProductResp
	6, // 8: product.ProductCatalogServie.SearchProducts:output_type -> product.SearchProductsResp
...
type ProductCatalogServie interface {
	ListProducts(ctx context.Context, req *ListProductReq) (res *ListProductsResp, err error)
