...
var (
	productCatalogServieServiceInfo                = NewServiceInfo()
	productCatalogServieServiceInfoForClient       = NewServiceInfoForClient()
	productCatalogServieServiceInfoForStreamClient = NewServiceInfoForStreamClient()
)

// for server
func serviceInfo() *kitex.ServiceInfo {
	return productCatalogServieServiceInfo
}

// for client
func serviceInfoForStreamClient() *kitex.ServiceInfo {
	return productCatalogServieServiceInfoForStreamClient
}

// for stream client
func serviceInfoForClient() *kitex.ServiceInfo {
	return productCatalogServieServiceInfoForClient
}
...
func newServiceInfo(hasStreaming bool, keepStreamingMethods bool, keepNonStreamingMethods bool) *kitex.ServiceInfo {
	serviceName := "ProductCatalogServie"
	handlerType := (*product.ProductCatalogServie)(nil)
...
func listProductsHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(product.ProductCatalogServie).ListProducts(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *ListProductsArgs:
		success, err := handler.(product.ProductCatalogServie).ListProducts(ctx, s.Req)
		if err != nil {
			return err
		}
...
func getProductHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(product.ProductCatalogServie).GetProduct(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *GetProductArgs:
		success, err := handler.(product.ProductCatalogServie).GetProduct(ctx, s.Req)
		if err != nil {
			return err
		}
...
func searchProductsHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(product.ProductCatalogServie).SearchProducts(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *SearchProductsArgs:
		success, err := handler.(product.ProductCatalogServie).SearchProducts(ctx, s.Req)
		if err != nil {
			return err
		}
...
func (p *kClient) ListProducts(ctx context.Context, Req *product.ListProductReq) (r *product.ListProductsResp, err error) {
