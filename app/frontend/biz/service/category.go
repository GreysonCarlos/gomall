...
import (
	...
	category "github.com/GreysonCarlos/gomall/app/frontend/hertz_gen/frontend/category"
...
func (h *CategoryService) Run(req *category.CategoryReq) (resp map[string]any, err error) {
	// todo edit your code
	p, err := rpc.ProductClient.ListProducts(h.Context, &product.ListProductReq{CatagoryName: req.Category})
	if err != nil {
		return nil, err
	}
