...
type Request struct {
	...
	Message string `protobuf:"bytes,1,opt,name=message,proto3" json:"message,omitempty"` // 类型 变量 = 序列号
}
...
var file_echo_proto_rawDesc = []byte{
	...
	0x72, 0x6c, 0x6f, 0x73, 0x2f, 0x64, 0x65, 0x6d, 0x6f, 0x2f, 0x64, 0x65, 0x6d, 0x6f, 0x5f, 0x70,
